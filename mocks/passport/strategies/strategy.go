...
// Strategy_Deactivate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Deactivate'
type Strategy_Deactivate_Call struct {
	*mock.Call
}
...
func (_c *Strategy_Deactivate_Call) Return(_a0 error) *Strategy_Deactivate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Strategy_Deactivate_Call) RunAndReturn(run func(context.Context, string, int64) error) *Strategy_Deactivate_Call {
	_c.Call.Return(run)
	return _c
}
