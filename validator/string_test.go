...
func TestStringRequired(t *testing.T) {
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringRequired("name", testdata.Fake.App().Name())())
	})
...
func TestStringStartsWithIfNotEmpty(t *testing.T) {
	...
	t.Run("OK - empty", func(st *testing.T) {
		require.NoError(st, StringStartsWithIfNotEmpty("name", "", prefix)())
	})
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringStartsWithIfNotEmpty("name", prefix+" - "+testdata.Fake.Company().JobTitle(), prefix)())
	})
	t.Run("KO", func(st *testing.T) {
...
func TestStringStartsWith(t *testing.T) {
	prefix := testdata.Fake.Company().Name()
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringStartsWith("name", prefix+" - "+testdata.Fake.Company().JobTitle(), prefix)())
	})
	t.Run("KO", func(st *testing.T) {
...
func TestStringStartsWithOneOf(t *testing.T) {
	...
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringStartsWithOneOf("agent", oneOf[0], oneOf)())
	})
	t.Run("KO", func(st *testing.T) {
...
func TestStringUri(t *testing.T) {
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringUri("uri", testdata.Fake.Internet().URL())())
	})
	t.Run("KO", func(st *testing.T) {
...
func TestStringLen(t *testing.T) {
	...
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringLen("id", id, len(id)/2, len(id)*2)())
	})
...
func TestStringLenIfNotEmpty(t *testing.T) {
	id := testdata.Fake.UUID().V4()
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringLenIfNotEmpty("id", id, len(id)/2, len(id)*2)())
	})
	t.Run("Ok - empty", func(st *testing.T) {
		require.NoError(st, StringLenIfNotEmpty("id", "", len(id)/2, len(id)*2)())
	})
}
...
func TestStringOneOf(t *testing.T) {
	...
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringOneOf("agent", oneOf[0], oneOf)())
	})
	t.Run("KO", func(st *testing.T) {
...
func TestStringAlphaNumericUnderscore(t *testing.T) {
	...
	t.Run("OK", func(st *testing.T) {
		require.NoError(st, StringAlphaNumericUnderscore("name", name+"_"+name)())
	})
	t.Run("KO", func(st *testing.T) {
